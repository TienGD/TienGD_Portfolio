...
document.querySelectorAll('.skill-card, .experience-card, .feature-box').forEach(el => {
    el.style.opacity = '0';
...
console.log('%cGame Developer | AI Researcher | Computer Science Student', 'font-size: 14px; color: #764ba2;');
